      ...
      return {
        ...
        description: (
          <>
            ...
            familiars... Us oferim tota la informació per gaudir de {label} i
            de la seva enorme activitat cultural. No cal moderació, la podeu
            gaudir a l&apos;engròs.
          </>
        ),
        metaTitle: `Què fer ${byDate} a ${label}`,
        metaDescription: `Què fer ${byDate} a ${label}. Us oferim tota la informació per gaudir de ${label} i de la seva enorme activitat cultural: cinema, museus, teatre, mercats, familiar. . Us oferim tota la informació per gaudir de ${label} i de la seva enorme activitat cultural: cinema, museus, teatre, mercats, familiar.`,
        ...extraProps,
      };
    } else if (byDate === "setmana") {
      return {
        title: `Coses per fer a ${label} aquesta ${byDate}`,
        subTitle: `Us proposem activitats d'oci i cultura a ${label} per a tots els gustos i butxaques.`,
        ...
        metaTitle: `Què fer aquesta ${byDate} a ${label}`,
        metaDescription: `Què fer aquesta ${byDate} a ${label}. Teniu ganes de gaudir de aquesta setmana? Teatre, cinema, música, art i altres excuses per no parar de descobrir ${label}!`,
        ...extraProps,
      };
    } else if (byDate === "cap-de-setmana") {
      return {
        title: `Què fer aquest cap de setmana a ${label}`,
        subTitle: `Les millors propostes per esprémer al màxim el cap de setmana a ${label}, de divendres a diumenge.`,
        description: `Hem bussejat en l'agenda cultural de ${label} i us portem una tria
        ...
        moure-us de ${label}.`,
        metaTitle: `Què fer aquest cap de setmana a ${label}`,
        metaDescription: `Què fer aquest cap de setmana a ${label}. Les millors propostes culturals per esprémer al màxim el cap de setmana, de divendres a diumenge.`,
        ...extraProps,
      };
    }
  }
