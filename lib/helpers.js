...
export async function getCalendarEvents({
  ...
  const query = q ? `&q=${q}` : "";
  const gcalUrl = `https://www.googleapis.com/calendar/v3/calendars/d5c87644a31fb1296ac8ec2ff606e6b7845065255e98505ea94bb92ec3d35413@group.calendar.google.com/events?timeMin=${fromDate}${untilDate}${query}&singleEvents=true&orderBy=startTime&maxResults=${maxResults}&key=${process.env.NEXT_PUBLIC_GOOGLE_CALENDAR}`;
