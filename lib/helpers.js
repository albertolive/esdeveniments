...
export async function getWeather(normalizeRss, location = "catalunya") {
  if (normalizeRss || !location) return {};

  const url = `https://api.openweathermap.org/data/2.5/forecast?q=${location.toLocaleLowerCase()}&appid=${
