...
test('navigate to the homepage and click on the first event', async ({ page }) => {
  ...
  page.setDefaultTimeout(120000); // Increased timeout to 120 seconds
  ...
  await page.waitForSelector(firstEventSelector, { state: 'visible', timeout: 120000 }); // Increased timeout for selector
